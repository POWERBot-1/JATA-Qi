...
PKGS=(
  ...
  design-system icons branding dashboard memory learning ai-learning search automation universal-wallet crypto fx pki mobility logistics agriculture circular accreditation dns registry registrar game-engine game-world game-physics game-architect game-ai game-net game-economy game-audio game-esports game-publish game-liveops
