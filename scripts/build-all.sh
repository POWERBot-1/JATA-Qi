...
PKGS=(
  ...
  scheduler plugins readiness commerce organizations notifications policies feature-flags privacy policy-governance payments messaging ai-safety conversations
  robotics digital-twin tool-intelligence provenance
  ...
  orchestrator multimedia evals finance communication research education health self-evolution link-intelligence multimodal-intelligence supply-chain environment cyberdefense sdk active-defense soc supply-chain-security infra-governance resilience-engineering security-review security-automation dlp pqc product-marketplace onboarding operations iot smart-cities cloud-devops localization enterprise mfa disaster-recovery optimization synthetic-data business-intelligence mobile api-gateway mobile-app web-ui multimodal sovereign llm-gateway cli
)
