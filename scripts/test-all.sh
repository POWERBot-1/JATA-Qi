...
PKGS=(
  ...
  orchestrator multimedia evals finance communication research education health self-evolution supply-chain environment cyberdefense iot smart-cities cloud-devops localization enterprise api-gateway cli
)
